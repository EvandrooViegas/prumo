  ...
  return (
    <>
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden" data-testid="home-hero">
        <Image
          src={IMAGES.heroHome}
          alt="PRUMO SOALHEIRO — obra de construção"
          fill
          priority
        ...
        <div className="relative z-10 container mx-auto px-6 lg:px-10 pt-40 pb-24">
          <p className="text-brand-gold text-xs font-bold tracking-[0.35em] uppercase mb-5 animate-fade-up">
            PRUMO SOALHEIRO
          </p>
          <h1
            className="font-title text-white uppercase leading-[0.88] max-w-5xl animate-fade-up"
            style={{ fontSize: "clamp(3.5rem, 9vw, 8rem)", animationDelay: "80ms" }}
          ...
          <p
            className="mt-7 text-white/65 text-lg md:text-xl font-light italic max-w-xl animate-fade-up"
            style={{ animationDelay: "180ms" }}
          >
            "{t.slogan.secondary.replace("\n", " ")}"
          </p>
          <p
            className="mt-5 max-w-2xl text-white/80 text-base leading-relaxed animate-fade-up"
            style={{ animationDelay: "260ms" }}
          >
            {t.home.heroSubtitle}
          </p>
          <div className="mt-10 flex flex-wrap gap-4 animate-fade-up" style={{ animationDelay: "340ms" }}>
            <Link href="/orcamento" className="btn-gold" data-testid="home-cta-contact">
              {t.cta.contact} <ArrowRight size={16} />
            </Link>
            <Link href="/servicos" className="btn-outline-gold" data-testid="home-cta-services">
        ...
        <div className="container mx-auto px-6 lg:px-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <Link
                href="/sobre"
                className="mt-10 inline-flex items-center gap-2 text-brand-dark text-xs font-bold tracking-[0.18em] uppercase border-b-2 border-brand-gold pb-1 hover:text-brand-goldDark hover:border-brand-goldDark transition-colors"
              >
                {t.nav.about === "About us" ? "Learn more" : "Saber mais"} <ArrowRight size={14} />
              </Link>
            </div>

            {/* Staggered tall image pair — use high-res portrait shots */}
            <div className="grid grid-cols-2 gap-5">
              <div className="relative overflow-hidden" style={{ height: "520px" }}>
                <Image
                  src={IMAGES.homeGrid1}
                  alt="Fachada — Ministério da Justiça"
                  fill
              ...
              <div className="relative overflow-hidden mt-14" style={{ height: "520px" }}>
                <Image
                  src={IMAGES.homeGrid2}
                  alt="Obra em progresso"
                  fill
      ...
      <section className="bg-brand-light py-24 md:py-32" data-testid="home-services-section">
        <div className="container mx-auto px-6 lg:px-10">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
            ...
            <Link
              href="/servicos"
              className="inline-flex items-center gap-2 text-brand-dark text-xs font-bold tracking-[0.18em] uppercase border-b-2 border-brand-dark pb-1 hover:text-brand-goldDark hover:border-brand-goldDark transition-colors shrink-0 mb-2"
            >
              ...
              >
                ...
                <div className="absolute inset-x-0 bottom-0 p-8 text-white">
                  <span className="text-brand-gold text-[10px] font-bold tracking-[0.28em] uppercase">
                    {t.nav.about === "About us" ? `Area ${i + 1}` : `Área ${i + 1}`}
                  </span>
                  ...
                  <Link
                    href="/servicos"
                    className="mt-4 inline-flex items-center gap-1 text-brand-gold text-xs font-bold tracking-widest uppercase"
                  >
          ...
          <div className="mt-6 grid md:grid-cols-3 gap-6">
            {t.services.list.slice(2).map((s, i) => (
              <article
                ...
                className="relative overflow-hidden group cursor-pointer"
                style={{ height: "420px" }}
                data-testid={`home-service-card-${i + 2}`}
              >
                <Image
                ...
                <div className="absolute inset-x-0 bottom-0 p-7 text-white">
                  <span className="text-brand-gold text-[10px] font-bold tracking-[0.28em] uppercase">
                    {t.nav.about === "About us" ? `Area ${i + 3}` : `Área ${i + 3}`}
                  </span>
                  ...
                  <Link href="/servicos" className="mt-3 inline-flex items-center gap-1 text-brand-gold text-xs font-bold tracking-widest uppercase">
                    {t.cta.seeMore} <ChevronRight size={14} />
                  </Link>
                </div>
              </article>
      ...
      <section className="relative bg-brand-dark text-white py-24 md:py-32 grain" data-testid="home-portfolio-section">
        <div className="container mx-auto px-6 lg:px-10 relative z-10">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-14">
            ...
            <Link
              href="/projetos"
              className="inline-flex items-center gap-2 text-white text-xs font-bold tracking-[0.18em] uppercase border-b-2 border-brand-gold pb-1 hover:text-brand-gold transition-colors shrink-0 mb-2"
            >
              {t.nav.about === "About us" ? "All projects" : "Todos os projetos"} <ArrowRight size={14} />
            </Link>
          </div>

          {/* Featured (big) + 3 stacked */}
          <div className="grid lg:grid-cols-5 gap-5">
            {/* Featured — Ministry of Justice — takes 3 cols */}
            <article
              className="relative lg:col-span-3 overflow-hidden group"
              style={{ height: "680px" }}
            ...
            >
              ...
              <div className="absolute top-6 left-6">
                <span className="bg-brand-gold text-brand-dark text-[10px] font-bold tracking-[0.2em] uppercase px-4 py-2">
                  {t.projects.tagPrimary}
                </span>
              </div>
              <div className="absolute inset-x-0 bottom-0 p-10">
                ...
                <Link href="/projetos" className="mt-6 btn-outline-gold !py-3 !px-5 text-xs">
                  {t.cta.seeMore} <ChevronRight size={14} />
                </Link>
              </div>
            </article>

          {/* 2 smaller stacked — 2 cols */}
      ...
      <section className="bg-brand-light py-24 md:py-32" data-testid="home-differential-section">
        <div className="container mx-auto px-6 lg:px-10 grid lg:grid-cols-2 gap-14">
          <div>
            ...
            <h2 className="font-title uppercase text-5xl md:text-6xl leading-[0.93] mt-5 text-brand-dark">
          ...
          <div className="space-y-5 lg:pt-20">
            {t.differentials.slice(1).map((d, i) => (
              <div key={i} className="bg-white border border-brand-gray p-8" data-testid={`home-differential-card-${i}`}>
                <h3 className="font-title uppercase tracking-wider text-xl text-brand-dark pb-4 border-b border-brand-gray/60">
                  {d.title}
                </h3>
        ...
        <div className="container mx-auto px-6 lg:px-10 relative z-10">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5">
            {t.quotes.slice(0, 4).map((q, i) => (
              <blockquote
                key={i}
                className="bg-white/5 border border-white/10 p-8 hover:border-brand-gold transition-colors duration-300"
              >
          ...
          <div>
            ...
            <p className="mt-3 text-brand-dark/70 text-base">
              {t.nav.about === "About us"
                ? "Contact us today and get a free no-obligation quote."
